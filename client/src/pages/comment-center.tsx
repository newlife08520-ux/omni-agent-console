              ...
              {health.today_total === 0 && (
                <div className="rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
                  ...
                  <p className="text-amber-700 text-xs">
                    <strong>一鍵訂閱：</strong>到 <strong>設定 → 品牌與渠道</strong>，在該粉專的 Facebook Messenger 渠道旁點 <strong>「訂閱留言」</strong>，即可讓貼文留言送進收件匣。<br />
                    若仍無效，請到 <strong>Meta 開發者後台</strong>（developers.facebook.com）→ 您的應用程式 → <strong>Webhook</strong>：① 回呼網址 <code className="bg-amber-100 px-1 rounded">https://您的網域/api/webhook/facebook</code> ② 驗證權杖與 FB_VERIFY_TOKEN 一致 ③ 為粉專訂閱 <strong>feed</strong>。完成後在貼文留一則言測試。
                  </p>
                </div>
              )}
            </>
