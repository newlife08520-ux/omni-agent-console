...
server/
  ...
  superlanding.ts  - 一頁商店 API client (fetchOrders, lookupOrdersByPhone, lookupOrderById)
...
- GET /api/orders/lookup?phone=|order_id= — manual order search
...
3. **一頁商店 API Integration**: Order lookup by phone/order_id via Super Landing API
