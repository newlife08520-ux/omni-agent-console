...
export class SQLiteStorage implements IStorage {
  ...
  createAiLog(data: Parameters<typeof aiLogsRepo.createAiLog>[0]): AiLog {
    return aiLogsRepo.createAiLog(data);
  }

  getAiLogs(contactId: number): AiLog[] {
    return aiLogsRepo.getAiLogs(contactId);
  }
  ...
  getAiLogStats(startDate: string, endDate: string, brandId?: number): {
    ...
    return aiLogsRepo.getAiLogStats(startDate, endDate, brandId);
  }
  ...
  createAssignmentRecord(
    ...
    if (hasExtra) {
      ...
      return {
        ...
        note,
        action_type: (actionType ?? null) as import("@shared/schema").AssignmentLogActionType | null,
