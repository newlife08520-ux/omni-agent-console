...
function seedMockData() {
  ...
  const contacts = [
    {
      platform: "line", platform_user_id: "U1a2b3c4d5e6f7", display_name: "陳小明",
      avatar_url: null, needs_human: 0, status: "resolved", tags: '["VIP"]',
      last_message_at: "2026-03-01T14:30:00", created_at: "2026-02-28T09:00:00",
    },
    {
      platform: "line", platform_user_id: "U2b3c4d5e6f7a8", display_name: "林美玲",
      avatar_url: null, needs_human: 1, status: "processing", tags: '["客訴","重要"]',
      last_message_at: "2026-03-01T14:45:00", created_at: "2026-02-27T11:30:00",
    },
    {
      platform: "line", platform_user_id: "U3c4d5e6f7a8b9", display_name: "王大維",
      avatar_url: null, needs_human: 0, status: "pending", tags: '[]',
      last_message_at: "2026-03-01T13:15:00", created_at: "2026-02-26T15:20:00",
    },
    {
      platform: "line", platform_user_id: "U4d5e6f7a8b9c0", display_name: "張雅婷",
      avatar_url: null, needs_human: 0, status: "resolved", tags: '["VIP","回購客戶"]',
      last_message_at: "2026-03-01T10:00:00", created_at: "2026-02-25T08:45:00",
    },
    {
      platform: "line", platform_user_id: "U5e6f7a8b9c0d1", display_name: "李志豪",
      avatar_url: null, needs_human: 1, status: "pending", tags: '["新客戶"]',
      last_message_at: "2026-03-01T15:10:00", created_at: "2026-03-01T14:50:00",
    },
  ];
  ...
  const insertTeam = db.prepare(
    "INSERT INTO team_members (name, email, role, avatar_url, status, created_at) VALUES (?, ?, ?, ?, ?, ?)"
  );
  const teamMembers = [
